...
enc_train_inp_lengths = tf.compat.v1.placeholder(tf.int32, shape=[batch_size],name='train_input_lengths')
dec_train_inp_lengths = tf.compat.v1.placeholder(tf.int32, shape=[batch_size],name='train_output_lengths')
...
#defining decoder cell using lstm and Luong attention
# Build RNN cell
