 ...
 */
    /*search the whole linked list and allocate the minist space that can hold the process*/
 ...
 *				merge					     *
 *===========================================================================*/
PRIVATE void merge(hp) register struct hole *hp; /* ptr to hole to merge with its successors */
{
 ...
 *				mem_init				     *
 *===========================================================================*/
PUBLIC void mem_init(chunks, free) struct memory *chunks; /* list of free memory chunks */
 ...
 *				swap_on					     *
 *===========================================================================*/
PUBLIC int swap_on(file, offset, size) char *file; /* file to swap on */
 ...
 *				swap_inqueue				     *
 *===========================================================================*/
PUBLIC void swap_inqueue(rmp) register struct mproc *rmp; /* process to add to the queue */
{
